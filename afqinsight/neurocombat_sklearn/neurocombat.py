...
class CombatModel(BaseEstimator):
    """Harmonize/normalize features using Combat's [1]
    ...
    def _standardize_across_features(
        ...
        estimates of the prior distribution.
        To avoid this, the features are standardized to all of them have similar
    ...
    def _find_parametric_adjustments(
        ...
        """Compute empirical Bayes site/batch effect parameter
        estimates using parametric empirical priors"""
    ...
    def _iteration_solver(
        ...
        """Compute iterative method to find the
        parametric site/batch effect adjustments"""
